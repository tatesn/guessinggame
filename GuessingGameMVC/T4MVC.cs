...
{
    public static GuessingGameMVC.Controllers.AccountController Account = new GuessingGameMVC.Controllers.T4MVC_AccountController();
    public static GuessingGameMVC.Controllers.HomeController Home = new GuessingGameMVC.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string jquery_signalR_2_0_1_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.signalR-2.0.1.min.js") ? Url("jquery.signalR-2.0.1.min.js") : Url("jquery.signalR-2.0.1.js");
        public static readonly string jquery_signalR_2_0_1_min_js = Url("jquery.signalR-2.0.1.min.js");
